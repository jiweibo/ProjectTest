...
// void MatmulOp::print(::mlir::OpAsmPrinter &printer) {
...
//   // // If all of the types are the same, print the type directly.
//   // Type resultType = operation->result_type_begin();
//   // if (llvm::all_of(op->getOperandTypes(),
//   //                  [=](Type type) { return type == resultType; })) {
//   //   printer << resultType;
//   //   return;
...
//   // Otherwise, print a functional type.
//   printer.printFunctionalType(operation->getOperandTypes(), operation->getResultTypes());
// }

void MatmulOp::build(::mlir::OpBuilder &odsBuilder, ::mlir::OperationState &odsState, Value lhs, Value rhs) {
