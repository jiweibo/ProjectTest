...
//   ComplexTypeStorage(unsigned nonZeroParam, mlir::IntegerType integerType) :
...
//   /// Note: This isn't necessary because std::pair, unsigned, and Type all
//   have
...
//   storage. static ComplexTypeStorage* construct(mlir::TypeStorageAllocator
//   &allocator,
//                                        const KeyTy &key) {
...
//   /// This method is used to get an instance of the 'ComplexType'. This
//   method
//   /// asserts that all of the construction invariants were satisfied. To
//   /// gracefully handle failed construction, getChecked should be used
//   instead. static ComplexType get(::mlir::MLIRContext *context, unsigned
//   param, mlir::IntegerType type) {
//     // Call into a helper 'get' method in 'TypeBase' to get a uniqued
//     instance
...
//   /// This method is used to get an instance of the 'ComplexType'. If any of
//   the
//   /// construction invariants are invalid, errors are emitted with the
//   provided
...
//   /// This method is used to verify the construction invariants passed into
//   the
//   /// 'get' and 'getChecked' methods. Note: This method is completely
//   optional. static mlir::LogicalResult
//   verify(mlir::function_ref<mlir::InFlightDiagnostic()> emitError,
//                               unsigned param, mlir::IntegerType type) {
